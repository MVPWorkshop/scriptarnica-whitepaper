...
He is passionate about developing products, systems, and working with people dedicated to building flat organizations in his search for game-changing brands that improve consumers’ lives.
Ivan’s engineering background is in DevOps, System Engineering and Customer Support Analytics, and while he says he is a semi-retired and washed up engineer we still sometimes refer to him when we need a fresh pair of eyes to solve a problem related to basic software engineering concepts.
...
A research and development engineer armed with Masters
degrees in both Genetic Algorithms and Philosophy, Pusonja is a
dynamic professional with nearly a decade of experience. On
behalf of Devana Labs, he built Lemon e-mail - world's first
encrypted and decentralized e-mail service, which further
deepened his knowledge and interest in this exponentially
growing field of technology. After a successful career in software
development, Mališa became an expert and lead of Blockchain
R&D teams. As a CTO of MVP Workshop, he is in charge of the
whole technical team, processes, culture and various
blockchain-based products and their architectures. Due to his
unique set of skills that involve data science, engineering, and
philosophy, Mališa is considered as a leading Blockchain R&D
expert, internationally. His great passion lies in developing
products that create new business value and are technically
innovative. A philosopher at heart, Mališa perceives technology
as the catalyst for change and is curious to witness how his
team’s local efforts will contribute to making global changes.
...
He is a designer with over 13 years of experience. His current focus is on building digital products with a special attention on designing beautiful and functional interactive experiences. He has skills ranging from graphic design and coding to product design and entrepreneurship.
He is very busy oriented and efficient and rarely throws any tantrums. His colleagues usually consider him the calm voice of reason they can always rely on. Antun has been on both sides. From freelancing and aiding small startups and design agencies to working with big players and on full product lifecycle projects - it's safe to say that he knows how to balance both sides and get the best out of them.
...
Studied informatics at Faculty of Mathematics in Belgrade, Executive MBA student at COTRUGLI Business School.
...
Nemanja has hands-on experience for projects over 25 Million $ with full P&L responsibility.
We had to bring him over from our partner Trizma where he was in charge of Business Development and Marketing, as both sides learned he was much more passionate about Blockchain than about BPO.
His primary experience comes from premium automotive industry where he had to deal with stuff like general management, country and regional management, sales & marketing, premium car sales, dealer network development, digital marketing, outsourcing, user experience UX, data analytics, IoT, telematics, connected vehicles, software development projects and many other hi-tech words.
...
Since he was seven, he has been involved in his family's business focused on custom handmade shoes manufacturing where he learned to meet customers' needs and fulfill their desires.
He had a chance to work at Devana Technologies with Ivan Bjelajac and Mališa Pušonja and that is where he learned about Growth Hacking and digital products before moving on to become a Product Manager (Digital, Multimedia and Applications) at Vip mobile.
...
Đorđe has been working as a software engineer for past 5
years. Fluent in several programming languages, he has
valuable experience in working with both backend and
frontend web development technologies, as well as
managing databases. He has been a Core contributor to
Blockstack and works in the field of Ethereum Smart Contract
Development / DApps. Đorđe is known for his outstanding
organizational and leadership skills and has a proven track
record of successful contributions in leading MVP teams
working on Skriptarnica and Celsius app projects. He is proud
to be part of MVP workshop and together with rest of the
team work on developing blockchain solutions and
contribute to establishing the standards in this exponentially
growing field of technology. His spare time Đorđe spends
with the family and he is passionate about all sorts of
vehicles.
...
Driven and hardworking young software engineer (in training)
who has been studying the field since 2009. Andrej has a
comprehensive academic knowledge of Java, C and C++ and
working experience with PHP (Laravel), MySQL and Javascript.
He is curious about private blockchain and hyperledger and
strives to advance his knowledge in this fields. With an agile
approach to problem solving, he tries to be prepared sooner
rather than later, learn from his mistakes, and quickly adapt
to new situations. With ࠀࠀ hackathons and 8 awards behind,
Andrej is an experienced hackathon competitor who highly
values teamwork and perceives it as crucial factor for the
success. In his spare time, he enjoys playing sports and
...
Aleksandar is a website developer in charge of most of our websites and web assets we are creating both internally and for our clients.
He's the person to reach out if you need anything related to the website maintenance and WordPress development. You'll find him often trying to solve bugs and improve experience prior you even report something.
...
Marko is an accomplished Senior Executive and Board Member with demonstrated success across the international relations, outsourcing and telecommunication industries. Leveraging extensive experience in change management and growth strategies for organizations, he is a valuable asset for growing and transforming business needing guidance in the business development, process improvement and/or product development. His broad areas of expertise include strategic development, business transformations, growth strategies and business development.
